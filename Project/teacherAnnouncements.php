...
<body>
		...
		<nav class="navbar  navbar-expand-sm bg-info navbar-light fixed-top">
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
                ...
                <ul class="navbar-nav nav-pills">
                    ...
                    <li class="nav-item"><a class="nav-link active" id="navlink" id="navlink" href="teacherAnnouncements.php">Announcements</a></li>
                </ul>
    ...
    <main class="container">
        <div>
            ...
            <!-- basic table -->
            <table class="table table-info"><h1 class="justify-content-center bg-info text-white" id=t1 >Announcements<i class="fa fa-exclamation-triangle"></i></h1>
